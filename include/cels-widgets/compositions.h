 ...
 *
 *   WPanel(.title = "Settings") {
 *       WButton(.label = "Play", .selected = true) {}
 *       WSlider(.label = "Volume", .value = 0.7f) {}
 *       WDivider() {}
 *       WText(.text = "Hello world") {}
 *   }
 *
 * Each composition:
...
#define WInfoBox(...) CEL_Init(WInfoBox, __VA_ARGS__)
...
#define WBadge(...) CEL_Init(WBadge, __VA_ARGS__)
...
#define WTextArea(...) CEL_Init(WTextArea, __VA_ARGS__)

/* ============================================================================
 * Interactive Compositions
 * ============================================================================ */

CEL_Composition(WButton, const char* label; bool selected; bool focused; void (*on_press)(void); const TUI_ButtonStyle* style;) {
...
#define WSlider(...) CEL_Init(WSlider, __VA_ARGS__)
...
#define WCycle(...) CEL_Init(WCycle, __VA_ARGS__)
...
#define WProgressBar(...) CEL_Init(WProgressBar, __VA_ARGS__)
...
#define WMetric(...) CEL_Init(WMetric, __VA_ARGS__)

/* ============================================================================
 * Container Compositions
 * ============================================================================ */

CEL_Composition(WPanel, const char* title; int border_style; const TUI_PanelStyle* style;) {
...
#define WTable(...) CEL_Init(WTable, __VA_ARGS__)
...
#define WRadioButton(...) CEL_Init(WRadioButton, __VA_ARGS__)
...
#define WRadioGroup(...) CEL_Init(WRadioGroup, __VA_ARGS__)
...
#define WTabBar(...) CEL_Init(WTabBar, __VA_ARGS__)
...
#define WTabContent(...) CEL_Init(WTabContent, __VA_ARGS__)
...
#define WStatusBar(...) CEL_Init(WStatusBar, __VA_ARGS__)
...
#define WListView(...) CEL_Init(WListView, __VA_ARGS__)
...
#define WListItem(...) CEL_Init(WListItem, __VA_ARGS__)
